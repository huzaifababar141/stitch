...
export async function PATCH(
  ...
  try {
    ...
    if (existingProfile.isDefault) {
      return apiSuccess(existingProfile, 200, { message: 'Measurement profile is already default' })
    }
    ...
    return apiSuccess(updatedProfile, 200, { message: 'Default measurement profile updated' })
  } catch (error) {
