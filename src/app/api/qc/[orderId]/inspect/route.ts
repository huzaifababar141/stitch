...
export async function POST(
  ...
  try {
    ...
    const updatedOrder = await submitInspection(inspector.id, params.orderId, data)
    return apiSuccess(updatedOrder, 200, { message: 'Inspection submitted successfully' })
  } catch (error) {
