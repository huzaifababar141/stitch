      ...
      <div className="w-full max-w-xl bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-gray-50/50">
          <div className="flex items-center gap-2">
            <PlayCircle className="text-[#7E153A]" size={22} />
            <div>
        ...
        <div className="bg-gray-900 text-white p-6 relative flex flex-col items-center justify-center text-center">
          <div className="w-14 h-14 rounded-full bg-[#7E153A] flex items-center justify-center shadow-lg shadow-[#7E153A]/50 mb-3 animate-pulse">
            <PlayCircle size={28} />
          </div>
        ...
        <div className="p-6 overflow-y-auto space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {MEASUREMENT_GUIDES.map((guide) => (
              ...
              >
                <h5 className="font-bold text-sm text-[#7E153A] mb-1">
                  {guide.title}
                </h5>
          ...
          <div className="p-4 rounded-xl bg-red-50/50 border border-red-100 flex items-center gap-3 text-xs text-gray-700">
        ...
        <div className="flex justify-end px-6 py-4 border-t border-gray-100 bg-gray-50/50">
          <Button
            onClick={onClose}
            className="bg-[#7E153A] hover:bg-[#630f2d] text-white h-9 text-xs font-semibold px-6"
          >
